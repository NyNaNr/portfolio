...
import fragShader from "../../app/(home)/displacementSphereFragment.glsl"
import vertShader from "../../app/(home)/displacementSphereVertex.glsl"
...
export const DisplacementSphere = (props) => {
  ...
  useEffect(() => {
    ...
    renderer.current.setSize(width, adjustedHeight) //すこしはみ出る問題　元は　renderer.current.setSize(width * 0.988, adjustedHeight)←PCOK、スマホOUT
